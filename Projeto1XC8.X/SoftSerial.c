#include "SanUSB1X.h" //Emulação de uma softserial (porta serial) nos pinos B4 e B5 via software
#include <plib/sw_uart.h> //Pino B4 (Tx) e Pino B5 (Rx) //http://www.youtube.com/watch?v=6HBbMR2a2I0
