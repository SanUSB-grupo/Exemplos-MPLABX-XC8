...
#define entrada_pin_d0 PORTDbits.RD0
#define entrada_pin_d1 PORTDbits.RD1
#define entrada_pin_d2 PORTDbits.RD2
#define entrada_pin_d3 PORTDbits.RD3
#define entrada_pin_d4 PORTDbits.RD4
#define entrada_pin_55 PORTDbits.RD5
#define entrada_pin_d6 PORTDbits.RD6
#define entrada_pin_d7 PORTDbits.RD7
