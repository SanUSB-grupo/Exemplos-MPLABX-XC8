...
// inserir o desvio _asm goto interrupcao _endasm  na função void _high_ISR (void){   } em SanUSB1.h
...
multiplica_timer16bits(1,16);           //liga timer3 - 16 bits com multiplicador (prescaler) 8
tempo_timer16bits(1,50000);		//Conta 8 x 50000us = 0,4 seg.
